...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("client", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("client", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "client";
		app.meta["name"] = "client";
